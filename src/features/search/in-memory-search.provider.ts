...
export class InMemorySearchProvider implements ISearchProvider {
  ...
  public setIndex(
    ...
    if (structures !== undefined) {
      this.galacticStructures = structures;
    }
    if (galaxies !== undefined) {
      this.galaxies = galaxies;
    }
    if (cosmicStructures !== undefined) {
      this.cosmicStructures = cosmicStructures;
    }
    if (cosmicEpochs !== undefined) {
      this.cosmicEpochs = cosmicEpochs;
    }
